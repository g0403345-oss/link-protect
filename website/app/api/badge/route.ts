...
function badgeSvg(right: string): string {
  ...
  <g clip-path="url(#r)">
    <rect width="${leftW}" height="${h}" fill="#18181b"/>
  ...
  <g fill="#f2f3f5" font-family="${FONT}" font-size="11" font-weight="700" text-anchor="middle">
...
export async function GET(req: NextRequest) {
  ...
  return new NextResponse(badgeSvg(right), {
    headers: {
